     ...
     <img
      ...
      />
        ...
        <div className="absolute w-full text-center top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white p-4 md:text-left md:transform-none md:translate-x-0 md:translate-y-0 md:bottom-0 md:left-0 md:top-auto md:p-6">
          ...
          <Button className="font-semibold hidden md:block bg-gradient-to-r from-cyan-500 to-blue-500 text-white"  size="lg" onPress={handlePress}>
            <FontAwesomeIcon className="text-white pr-2" icon={faWhatsapp} size="xl" shake />
            Contact Me!
          </Button>
        </div>
    </section>
